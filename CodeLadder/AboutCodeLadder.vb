Public NotInheritable Class AboutCodeLadder

    Private Sub AboutCodeLadder_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
